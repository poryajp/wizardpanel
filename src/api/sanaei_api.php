...
function resetSanaeiUserUsage($username, $server_id)
{
    // در پنل Sanaei/3x-ui، یک endpoint مستقیم برای reset usage وجود ندارد
    // ولی با تنظیم مجدد totalGB از طریق modifySanaeiUser، usage به طور خودکار ریست می‌شود
    // بنابراین این تابع صرفاً برای سازگاری با interface وجود دارد
    // عملیات ریست در تابع modifySanaeiUser انجام شده است
    return true;
}